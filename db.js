...
module.exports.CreateDB = function (meshserver) {
    ...
    obj.initFunctions = function () {
        ...
        obj.getStuckJobs = function (timeoutSeconds) {
            var thresholdTime = Math.floor(new Date() / 1000) - timeoutSeconds;
            return obj.scriptFile.find({
                type: 'job',
                completeTime: null,
                ...
                $or: [
                    ...
                    { lastPing: null, dispatchTime: { $lt: thresholdTime } }
                ]
            }).toArray();
        };
        ...
        obj.deletePendingJobsForScript = function (scriptId) {
            return obj.scriptFile.deleteMany({ type: 'job', scriptId: scriptId, completeTime: null });
        };
